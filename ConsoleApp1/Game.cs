    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (choice1 == 1) {
                ...
                Console.Write("you see the front door to the building is open and it starts to rain. so reluctently you go back into the building with your "+weapon+ " grasped ");
            }
            ...
            Console.WriteLine("As you run down the corridoor you see a bathroom on your left what do you do?");
            ...
            if (choice2 == 1)
            {
                ...
                if (choice3 == 1 && weapon == "bannana")
                {
                    Console.WriteLine("You get out the weapon Dan gave you and see it is a bannana, the Clowns face drops and he begins to turn around when you slap him the bannana and it opens like an bag and sucks him into the bag and zipped it up, Dan appears and laughs saying \" Well done " + name + " you saved Codenation from destruction!\" Dan gives you 1,000,000 Stu bucks ");
